...
2. **Production Architecture**: Scalable to 100GB+ data
3. **Vector Search**: Semantic table discovery with Weaviate
4. **SQL Generation**: Both LLM and rule-based approaches
5. **State Management**: LangGraph for workflow orchestration
6. **User Experience**: Professional Streamlit interface
...
This project is created for educational purposes as part of a GenAI assignment.

## 🙏 Acknowledgments

- ServiceNow for the opportunity
